...
public class W5_1_Player {
	...
	// 戦略を表すフィールドを宣言
	private W5_1_Tactics jankenTactics;
	
	/*
	*コンストラクタ名：W5_1_Player
	*概要：プレイヤーの名前を初期化
	*引数：名前(String型)
	*作成者：N.Kimoto
	*作成日：2024/06/27
	*/
	public W5_1_Player(String playerName) {
		// プレイヤーの名前を引数の名前で初期化
	...
	*作成日：2024/06/28
	*/
	public void setTactics(W5_1_Tactics jankenTactics) {
		// プレイヤーに戦略を伝える
